...
model_save_path = "/home/zaimaz/Desktop/research1/VoiceDeepfakeDetector/Code/VoiceDeepfakeDetector/ckpt/best_single.pth" #  Best model save path
...
# Extract (x1=deepsonar features, y=labels) from real and fake samples
x1, y = extract_features(fake_root_dir, real_root_dir, feat_save_dir=feat_save_dir, dataset_size=None, extract_feats=extract_feats)
...
for x1, _ in train_loader:
    ...
    dim1 = x1.shape[-1]
    break
# Create Multi-Feature model with input dimensions: dim1=size of deepsonar feature vector for a sample
